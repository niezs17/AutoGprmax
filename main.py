...
if __name__ == '__main__':
    generate(TEXT_INTACT_ROAD=TEXT_BASE, generate_num=1, air_cavity_num=0, water_cavity_num=1, time_window=time_window,
             soil_base_space={'x1': 0, 'y1': 0.8, 'z1': 0, 'x2': 2.0, 'y2': 1, 'z2': 0.0025}, generate_mode='all')
